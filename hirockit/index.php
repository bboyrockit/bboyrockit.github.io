            ...
            <div class="row contact-pa">
                <div class="col-lg-12 mobile-space" style="padding: 0px 20px 0px 20px">
                    <div class="row">
                        ...
                        <form id="contact-form" class="col-lg-12" method="post" action="contact-form-handler-2.php">
                        ...
                        <div class="col-lg-12">
                                ...
                                <div class="input-group contact-input mb-3">
                                    ...
                                    <input type="text" class="form-control box-bg" placeholder="Name" aria-label="name" name="name" id="name">
                                </div>
                        ...
                        <div class="col-lg-12">
                                ...
                                <div class="input-group contact-input mb-3">
                                    ...
                                    <input type="email" class="form-control box-bg" placeholder="Email Address" aria-label="email" name="email" id="email">
                                </div>
