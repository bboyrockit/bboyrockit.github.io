...
<head>
    ...
    <link rel="stylesheet" href="css/hirockit.css">
</head>
...
<body id="dark-mode">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light sticky-top">
        <div class="container">
            <a class="navbar-brand" href="index.html">Hi<b>Rockit</b>.com</a>
        ...
        <div class="container zindex">
            <div class="row">
                <div class="col-lg-7 banner-txt">
                    <h3>Hi, I’m Rockit!</h3>
                    <h6>PRODUCT DESIGNER [ UX|UI ]</h6>
                    <p>I’m a multifaceted creative designer. I love creating brands, developing web and mobile app interfaces. I’m a self taught product designer based in Las Vegas, Nevada with experience in front-end web development and delivering UX/UI design. I’m passionate about learning new techniques and applying those principles to solve a challenging task from conceptualizing to product strategy, prototyping and interface design.</p>
                    <h4>Body of work</h4>
                    <div>
                    <a href="#" class="bow-btns">Case Studies</a>
                    <a href="#" class="bow-btns">Webb & Apps</a>
                    <a href="#" class="bow-btns">Branding</a>
                    </div>
                </div>
                <div class="col-lg-5">
    ...
    <section id="contact">
        <div class="container">
            ...
            <div class="row contact-pa">
                <div class="col-lg-12 mobile-space" style="padding: 0px 20px 0px 20px">
                    <div class="row">

                        <form id="contact-form" class="col-lg-12" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                        ...
                        <div class="col-lg-12">
                                ...
                                <div class="input-group contact-input mb-3">
                                    ...
                                    <input type="text" class="form-control box-bg" placeholder="Name" aria-label="name" name="name">
                                </div>
                        ...
                        <div class="col-lg-12">
                                ...
                                <div class="input-group contact-input mb-3">
                                    ...
                                    <input type="email" class="form-control box-bg" placeholder="Email Address" aria-label="email" name="email">
                                </div>
                        ...
                        <div class="col-lg-12">
                                ...
                                <div class="form-group">
                                    <textarea class="form-control box-bg" placeholder="Ask a Question..." rows="3" name="message" id="message"></textarea>
                                </div>
                                <div class="con-btn-main wow fadeInUp" data-wow-delay=".2s" data-wow-duration="1s">
                                    <input type="submit" value="Submit Now" class="con-btn" name="submit">
                                </div>
                    ...
                    <div class="sub-main">
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-5 subscripe-btn">
                                <a href="#" data-toggle="modal" data-target="#exampleModal2">Subcribe</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="fop-btm text-center">
                        <h2>Copyright &copy; 2020. All rights reserved by <a href="#">HiRockit.com</a></h2>
                    </div>
                </div>
            </div>
        </div>
